  ...
  const projects: ProjectProps[] = [
    {
      ...
      link: 'https://htdinh-porfolio.netlify.app/',
      time: '09/2024',
    ...
    },
    {
      ...
      description:
        'Build the core backend for an e-commerce website (Nodejs backend)',
    ...
    },
    {
      ...
      description:
        'A personal blog where I usually post various subjects related to personal development',
      technologies: [
        'ReactJs',
        'NextJs',
        'Tailwind',
    ...
    },
    {
      ...
      description:
        'Make a music player with a simple user interface that can play music in the browser',
